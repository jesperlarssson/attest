...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside
      className={`absolute sm:fixed border-r bg-card-light border-edge-light dark:bg-card-dark dark:border-edge-dark shadow-md transition-all duration-500 ease-in-out ${
        isSidebarOpen
          ? "w-64 p-4"
