...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside
      className={`absolute border-r bg-card-light border-edge-light dark:bg-card-dark dark:border-edge-dark shadow-md transition-all duration-500 ease-in-out ${
        isSidebarOpen
          ? "w-64 p-4"
    ...
    >
      <div className="flex flex-col  justify-between h-full">
        <div className="absolute right-0 translate-y-1/2 h-full translate-x-8">
          <CollapseButton
        ...
        {user && isSidebarOpen && (
          <div className="pt-10 text-sm">
            <div className="flex flex-col items-center">
              ...
              <button
                onClick={() => logout()}
                className="border border-gray-200 text-sm   py-2 px-4 rounded transition duration-150 ease-in-out w-full"
              >
                Sign out
              </button>
            </div>
