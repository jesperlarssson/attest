...
const InvoiceDetails: React.FC<InvoiceDetailsProps> = ({ invoice, clearSelection }) => {
  ...
  return (
    <div className={twMerge(`p-6 rounded-lg  w-full h-full border border-gray-300`, invoice ? 'bg-white shadow-lg' : 'bg-gray-200 shadow-inner  flex justify-center items-center')}>
        {
            invoice ? <>
      ...
      <button onClick={clearSelection} className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
          Close
        </button>
        <button onClick={handleEnterNote} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
          Enter Note
        </button>
        <button onClick={handleForward} className="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded">
          Forward
        </button>
      ...
      </div></> : <div className='font-bold opacity-30'>Select an invoice...</div>
        }
