  ...
  return (
    <nav className="sticky top-0 left-0 w-full bg-white text-gray-800 shadow-md px-8 py-4 ">
      ...
      <div className="flex items-center">
        ...
        <Link
          href="/"
          className="text-xl font-bold hover:text-gray-600 transition duration-150 ease-in-out flex items-center mr-4"
        >
          <svg
            ...
            stroke="currentColor"
          >
            <path d="M3 22h18M12 2v15m-7 5h14"></path>
          </svg>
          Attest
        </Link>
          ...
          <div className="relative group">
            ...
            <div className="absolute top-12 opacity-0 group-hover:opacity-100 transition-all ease-in-out w-32 bg-gray-700 rounded py-1 px-2 -translate-x-6 pointer-events-none">
              <span className=" text-white text-xs ">
                Logged in as:<br/> <strong>{user.employmentId}</strong>
              </span>
            </div>
          </div>
        )}
